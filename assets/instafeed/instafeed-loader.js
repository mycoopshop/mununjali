        ...
        function on_get_insta_data(data) {
            if (typeof data === 'string') {
                ...
                if (typeof data === "undefined") {
                    ...
                    options.on_error("Instagram Feed: Your network has been temporary banned by Instagram because of too many requests. Consider increasing your 'cache_time'.", 4);
                    if (!data) return;
                }
